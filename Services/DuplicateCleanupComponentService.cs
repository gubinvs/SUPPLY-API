...
{
    public class DuplicateCleanupComponentService : BackgroundService
    {
        /// <summary>
        /// 📌 Что делает этот код:
        ...
        private readonly ILogger<DuplicateCleanupComponentService> _logger;

        public DuplicateCleanupComponentService(IServiceProvider serviceProvider, ILogger<DuplicateCleanupComponentService> logger)
        {
