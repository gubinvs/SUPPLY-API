...
// namespace encomponent.api.Services
// {
...
//                     {
//                         var dbContext = scope.ServiceProvider.GetRequiredService<UserSystemContext>();

//                         var thresholdTime = DateTime.UtcNow.AddHours(-48);
//                         var usersToRemove = await dbContext.UserSystem
//                             .Where(u => !u.IsConfirmed && u.DataReg < thresholdTime)
//                             .ToListAsync(stoppingToken);

//                         if (usersToRemove.Any())
//                         {
//                             dbContext.UserSystem.RemoveRange(usersToRemove);
